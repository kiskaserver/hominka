...
_INJECTOR_NOTE = (
    ...
    "самого вікна чату, стилем у реальному часі, і прихованням від OBS (на всіх "
    "API — DirectX 9/11/12, OpenGL, Vulkan: у грі видно, в ефір не потрапляє). "
    "Вимкнено за замовчуванням. Бібліотека непідписана — Windows може "
