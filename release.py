...
# спрацює.
CHANNEL_WARNINGS = {
    "beta": ("У бета-каналі є експериментальний «справжній чат у грі»: Hominka вкладає "
             "власну бібліотеку в процес гри, щоб малювати чат поверх неї (⚙ → «Поверх "
             "гри»). Це на свій ризик: у ЗМАГАЛЬНИХ іграх з античитом (Valorant, CS2, "
             "Rust, Apex, EFT…) інʼєкція загрожує баном — туди програма не пускає. "
             "Чат у грі видно і в OBS Game Capture. За замовчуванням вимкнено; у "
             "стабільному каналі цієї можливості немає взагалі."),
}
