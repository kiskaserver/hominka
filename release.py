...
# спрацює.
CHANNEL_WARNINGS = {
    "beta": ("У бета-каналі є експериментальне дублювання чату в OSD RivaTuner (RTSS): "
             "Hominka пише останні рядки чату у вільний слот чужої програми — без аватарок "
             "і емоутів, зате видно навіть у виключному повноекранному режимі. За "
             "замовчуванням вимкнено, вмикається галочкою в ⚙; якщо RTSS не встановлено, "
             "не станеться нічого. У стабільному каналі цієї можливості немає взагалі."),
}
