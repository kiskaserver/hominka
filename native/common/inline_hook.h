...
public:
    ...
    bool install(void* target, void* detour) {
        ...
        int copied = 0;
        // RIP-відносні операнди перераховуємо лише на x64; на x86 їх не буває,
        // тож там ці два лишаються невжитими — про це й кажемо компілятору.
        [[maybe_unused]] int rip_at[8];
        [[maybe_unused]] int rip_n = 0;
