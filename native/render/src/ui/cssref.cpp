...
const std::vector<CssRecipe> kRecipes = {
    ...
    {"Сховати службові рядки",
     "Режими чату, бали, модерація, підказки площадки.",
     ".m[data-event=\"mode\"],\n.m[data-event=\"points\"],\n.m[data-event=\"ban\"],\n"
     ".m[data-event=\"unban\"],\n.m[data-event=\"unpin\"],\n.m[data-event=\"info\"],\n"
     ".m[data-event=\"live\"] { display: none; }"},
    {"Помітити перше повідомлення",
     "Людина написала в чат уперше — саме той момент, коли варто привітатися.",
     ".m[data-event=\"first\"] { background: rgba(56,189,248,.25);\n"
...
const std::vector<CssSelector> kSelectors = {
    ...
    {".m[data-event=\"mode\"]",
     ...
     ".m[data-event=\"mode\"] {\n  display: none;\n}"},
    {".m[data-event=\"highlight\"]",
     "Виділене повідомлення",
     "Глядач витратив бали каналу, щоб його рядок не загубився (Twitch).",
     ".m[data-event=\"highlight\"] {\n  background: rgba(255,255,255,.14);\n"
     "  border-left: 4px solid #fff;\n}"},
    {".m[data-event=\"first\"]",
     "Перше повідомлення",
     "Людина пише в цьому чаті вперше.",
     ".m[data-event=\"first\"] {\n  background: rgba(56,189,248,.25);\n"
     "  border-radius: 8px;\n}"},
    {".m[data-event=\"returning\"]",
     "Глядач повернувся",
     "Twitch позначає тих, хто заходив раніше, але давно.",
     ".m[data-event=\"returning\"] {\n  border-left: 3px solid #38bdf8;\n}"},
    {".m[data-event=\"milestone\"]",
     "Віха",
     "Тижні перегляду поспіль, річниця модератора й подібні відзнаки Twitch.",
     ".m[data-event=\"milestone\"] {\n  background: rgba(250,204,21,.22);\n"
     "  border-radius: 8px;\n}"},
    {".m[data-event=\"donate\"]",
     "Донат у збір",
     "Оголошення про внесок у збір коштів на YouTube.",
     ".m[data-event=\"donate\"] {\n  background: rgba(34,197,94,.24);\n}"},
    {".m[data-event=\"poll\"]",
     "Опитування",
     "Початок і кінець опитування в чаті Kick.",
     ".m[data-event=\"poll\"] {\n  opacity: .75;\n}"},
    {".m[data-event=\"ban\"]",
     "Бан або тайм-аут",
     "Модератор спинив глядача. Поряд працює data-event=\"unban\" — зняття бана.",
     ".m[data-event=\"ban\"] {\n  color: #f87171;\n  opacity: .8;\n}"},
    {".m[data-event=\"unpin\"]",
     "Закріплення знято",
     "Пара до data-event=\"pin\": закріплене повідомлення прибрали.",
     ".m[data-event=\"unpin\"] {\n  display: none;\n}"},
    {".m[data-event=\"live\"]",
     "Ефір почався або скінчився",
     "Kick повідомляє про початок і кінець трансляції.",
     ".m[data-event=\"live\"] {\n  font-weight: 700;\n}"},
    {".m[data-event=\"redirect\"]",
     "Чат переїхав",
     "Kick перевів чат на інший канал.",
     ".m[data-event=\"redirect\"] {\n  opacity: .75;\n}"},
    {".m[data-event=\"info\"]",
     "Підказка площадки",
     "Службові повідомлення самого YouTube.",
     ".m[data-event=\"info\"] {\n  display: none;\n}"},
    {".ico",
     "Значок площадки",
    ...
    {".gif",
     "Гіфка з чату",
     "Гіфка з чату Twitch. Типово вписується у 4.5 рядка заввишки й у ширину "
     "вікна; щоб не показувати гіфки зовсім — display: none.",
     ".gif {\n  max-height: 3em;\n  border-radius: 8px;\n}"},
    {".at",
     "Звертання @нік",
