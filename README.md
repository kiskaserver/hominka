...
**Вихід** — ⚙ → «Вийти»: чистить куки профілю й забуває канал, узятий з
акаунта. Канал, вписаний руками, лишається — він до входу відношення не має.
Кнопка «Змінити акаунт» відкриває вхід під іншим акаунтом.
