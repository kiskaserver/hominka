...
#
# Усі вони — САМІ ЛИШЕ <path>, і це не випадковість: нативний рендер растеризує
# ці SVG через nanosvg, у якого немає шрифтового рушія. Значок із <text>
# виходив би там порожньою плиткою — так колись і було з «OG», доки його літери
# не перевели в контури (див. make_badge_og.py).
_KICK_BADGE_SVG = {
